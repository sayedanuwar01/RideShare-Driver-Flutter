...
import 'package:driverapp/Assistants/mapKitAssistant.dart';
...
class NewRideScreen extends StatefulWidget {
  static const String newRideScreen = "newRideScreen";

  final rideDetail;
  NewRideScreen({this.rideDetail});
...
class _NewRideScreenState extends State<NewRideScreen> {
  ...
  void getRideLiveLocationUpdates() {
    ...
    rideStreamSubscription =
      ...
      String rideRequestId = widget.rideDetail.ride_request_id;
      Map locMap = {
        ...
        children: [
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController controller) async {
              ...
              var pickUpLatLng = widget.rideDetail.pickup;
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            child: Text(
                              widget.rideDetail.pickup_address,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            child: Text(
                              widget.rideDetail.dropoff_address,
                              style: TextStyle(fontSize: 18.0),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ),
                        ...
                        onPressed: () async {
                          if (status == "accepted") {
                            ...
                            String rideRequestId =
                                widget.rideDetail.ride_request_id;
                            newRequestsRef
                                .child(rideRequestId)
                                .child("status")
                                .set(status);
                            ...
                            await getPlaceDirection(widget.rideDetail.pickup,
                                widget.rideDetail.dropoff);
  ...
  void updateRideDetails() async {
    if (isRequestingDirection == false) {
      ...
      if (status == "accepted") {
        destinationLatLng = widget.rideDetail.pickup;
      } else {
        destinationLatLng = widget.rideDetail.dropoff;
      }
  ...
  endTheTrip() async {
    ...
    var directionalDetails = await AssistantMethods.obtainPlaceDirectionDetails(
        widget.rideDetail.pickup, currentLatLng);
    ...
    showDialog(
      ...
      builder: (BuildContext context) => CollectFareDialog(
        paymentMethod: widget.rideDetail.payment_method,
